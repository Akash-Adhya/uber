...
//                         <h2 className='text-base font-medium'>Harry Sharma</h2>
//                         <h4 className='text-lg font-semibold'>WB 67 A 1234</h4>
//                         <p className='text-sm text-gray-600'>Tata Nano</p>
//                         <h4 className='font-medium text-sm'>
//                             <i className="ri-star-s-line"></i> 3.2
//                         </h4>
//                     </div>
//                 </div>
...
//                         <div>
//                             <h3 className='text-base font-bold'>₹193.20</h3>
...
//                 {/* Confirm Button */}
//                 <button className='w-full py-3 bg-black text-white text-lg font-semibold rounded-xl'>
//                     Confirm
//                 </button>
//             </div>
//         </div>
